...
Six printed parts (standoffs replaced by M6 flat-head bolts):
...
- **upper_sleeve / lower_sleeve / washer**: two-part bearing housing.
- **standoff**: printed spacer the M6 bolts pass through.

Run:
    uv run --script m2/cutter.py

Exports to m2/out/: plate, shoe, upper_sleeve, lower_sleeve, washer, standoff
                    (.step + .stl)
...
def main() -> None:
    ...
    # Bind names for the assembly-preview block below
    plate, shoe = parts["plate"], parts["shoe"]
    upper_sleeve, lower_sleeve = parts["upper_sleeve"], parts["lower_sleeve"]
    washer, standoff = parts["washer"], parts["standoff"]
